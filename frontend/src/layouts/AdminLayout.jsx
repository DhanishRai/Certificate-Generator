...
const AdminLayout = ({ title, children }) => {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-slate-100 via-primary-50/40 to-secondary-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
