      ...
      >
        ...
        <form onSubmit={handleSubmit} className="mt-5 flex flex-col gap-3 sm:flex-row">
          <motion.input
            ...
            className="w-full rounded-xl border border-slate-300 bg-white/80 px-3 py-2.5 outline-none focus:ring-2 focus:ring-primary-500 dark:border-slate-700 dark:bg-slate-800/80"
          />
        ...
        {result?.certificate ? (
          ...
          >
            <div className="flex items-center justify-between gap-3">
              ...
              <BadgeStatus status={result.status} />
            </div>
